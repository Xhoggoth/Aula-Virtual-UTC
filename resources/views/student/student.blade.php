                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('student/list') }}">Lista de alumnos</a></li>
            ...
            <div class="student-group-form">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Buscar por celular...">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="page-title">Alumnos UTC</h3>
                                    </div>
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="#" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Descargar</a>
