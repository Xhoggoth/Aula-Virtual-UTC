...
class TeacherController extends Controller
{
    ...
    public function saveRecord(Request $request)
    {
        ...
        try {
            ...
            Toastr::success('Se ha añadido correctamente.','Registrado');
            return redirect()->back();
        } catch(\Exception $e) {
            \Log::info($e);
            DB::rollback();
            Toastr::error('Error al añadir','Error');
            return redirect()->back();
        }
    }
    ...
    public function updateRecordTeacher(Request $request)
    {
        ...
        try {
            ...
            Toastr::success('Se ha actualizado correctamente.','Cambios');
            DB::commit();
            return redirect()->back();
    ...
    public function teacherDelete(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            Toastr::success('Registro eliminado correctamente','Eliminado');
            return redirect()->back();
        } catch(\Exception $e) {
            DB::rollback();
